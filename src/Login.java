...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     String contra=contrasena.getText();
        ...
        } else if (main.gu.BuscarCuentaDesactivada(apodo)!=null) {
       
           if (contra.equals(main.gu.BuscarUsuario(apodo).getContraseña())){
                JOptionPane.showMessageDialog(null, "Cuenta Activada,BIENVENIDO @" + apodo);
                main.gu.SetUsuarioLogeado(main.gu.BuscarUsuario(apodo));
                new InicioX(main).setVisible(true);
                this.dispose();
           }else {
                JOptionPane.showMessageDialog(null, "Contra mala");
